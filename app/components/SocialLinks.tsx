...
const links = [
  { icon: GithubIcon, href: "https://github.com/tu-usuario", label: "GitHub" },
  { icon: LinkedinIcon, href: "https://linkedin.com/in/tu-usuario", label: "LinkedIn" },
  { icon: Mail, href: "mailto:tu@email.com", label: "Email" },
];

export default function SocialLinks() {
  return (
    <div className="fixed left-8 bottom-1/3 flex flex-col gap-6 z-40">
      {links.map((link) => (
        <a
          key={link.label}
          href={link.href}
