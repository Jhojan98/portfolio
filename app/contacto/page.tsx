...
const contactInfo = [
  { icon: Mail, text: "jhojan.aragon@example.com", href: "mailto:jhojan.aragon@example.com" },
  { icon: LinkedinIcon, text: "linkedin.com/in/jhojanaragon", href: "https://linkedin.com/in/jhojanaragon" },
  { icon: GithubIcon, text: "github.com/JhojanAragon", href: "https://github.com/JhojanAragon" },
  { icon: MapPin, text: "Bogotá, Colombia", href: "#" },
];

const socialLinks = [
  { icon: GithubIcon, href: "https://github.com/JhojanAragon", label: "GitHub" },
  { icon: LinkedinIcon, href: "https://linkedin.com/in/jhojanaragon", label: "LinkedIn" },
  { icon: Mail, href: "mailto:jhojan.aragon@example.com", label: "Email" },
];
